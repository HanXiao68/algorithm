...
//#include <queue>
//
////这个代码的问题出现在thread的类是自定义的。可能是公司里的规范接口。
//
//
...
//
//    TimerQueue() : thread_pool_(hx::ThreadPool::ThreadPoolConfig{4, 4, 40, std::chrono::seconds(4)}) {
...
//
//    hx::ThreadPool thread_pool_;
//
//    std::atomic<int> repeated_func_id_;
//    hx::ThreadSafeMap<int, RepeatedIdState> repeated_id_state_map_;
//};
//
//}  // namespace hx
//
